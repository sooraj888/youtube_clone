...
export let videoScrenCurrentHeightRef: any = createRef().current;
...
export default function BottomTabBar({
  ...
  useFocusEffect(
    React.useCallback(() => {
      const onBackPress = () => {
        if (Number(videoScrenCurrentHeightRef) > 55) {
    ...
    <>
      <Animated.View
        onLayout={e => {
          ...
          videoScrenCurrentHeightRef = e.nativeEvent.layout.height;
          // if (viewHeight > 55) {
          //   setVidoScreenCurrentState('open');
          // } else if (viewHeight <= 55 && viewHeight <= 55) {
          //   setVidoScreenCurrentState('minimized');
        ...
        style={{
          ...
          bottom: heightAnimation.interpolate({
            inputRange: [55, Dimensions.get('window').height],
